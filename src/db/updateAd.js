...
export const updateAd = async (id, data, imagesUrl, user) => {
    ...
    if (urlsToDelete.length > 0) {
         const fileNamesToDelete = urlsToDelete.map(url => {
         ...
         if (fileNamesToDelete.length > 0) {
            ...
            if (storageError) {
                console.error("Error deleting removed files from bucket:", storageError);
            }
         }
    }
